describe('Party Horn Tests', () => {
  ...
  it('Volume of <audio> changes when slider input changes', () => {
    cy.get('#volume-slider').invoke('val', 33).trigger('input');
  ...
  it('Volume image changes when increasing from 0 to 1 volume level', () => {
  ...
  it('Volume image changes when increasing from 1 to 2 volume level', () => {
  ...
  it('Volume image changes when increasing from 2 to 3 volume level', () => {
  ...
  it('Honk button is disabled when the textbox input is emtpy or a non-number', () => {
  ...
  it('Error is shown when you type a number outside of given range for volume textbox input', () => {
